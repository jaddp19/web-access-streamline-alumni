        ...
        <main class="lg:col-span-9">
            ...
            @if ($activeTab === 'appearance')
                <div class="space-y-6">
                    ...
                    <section
                        class="bg-white dark:bg-[#242526] rounded-3xl shadow-sm border border-black/5 dark:border-white/5 p-6"
                        x-data="{
                        ...
                        <div
                            class="relative inline-flex w-full sm:w-auto p-1 rounded-2xl bg-[#F1EFE7] dark:bg-[#3A3B3C]">
                    ...
                    <section
                        ...
                        <form wire:submit.prevent="saveProfile" class="space-y-6">
                            ...
                            <div class="flex items-center gap-5">
                                ...
                                @else
                                    <div
                                        class="w-20 h-20 rounded-2xl bg-[#123524]/10 dark:bg-[#D4A537]/15 flex items-center justify-center text-[#123524] dark:text-[#D4A537] text-2xl font-bold shrink-0">
                            ...
                            <div>
                                ...
                                <div class="grid sm:grid-cols-2 gap-4">
                                    <div>
                                        <label
                                            class="block text-[11px] text-black/50 dark:text-white/50 font-semibold mb-1.5">Region
                                    ...
                                    @if ($regionCode)
                                        <div>
                                            <label
                                                class="block text-[11px] text-black/50 dark:text-white/50 font-semibold mb-1.5">Province
                                                <span class="text-red-500">*</span></label>
                                    ...
                                    @if ($provinceCode)
                                        <div>
                                            <label
                                                class="block text-[11px] text-black/50 dark:text-white/50 font-semibold mb-1.5">City
                                    ...
                                    @if ($cityCode)
                                        <div>
                                            <label
                                                class="block text-[11px] text-black/50 dark:text-white/50 font-semibold mb-1.5">Barangay
                                                <span class="text-red-500">*</span></label>
                                ...
                                <div class="mt-5">
                                    <label
                                        class="block text-[11px] text-black/50 dark:text-white/50 font-semibold mb-1.5">Street
                            ...
                            {{-- Actions --}}
                            <div
                                class="flex items-center justify-end gap-3 pt-4 border-t border-black/5 dark:border-white/10">
