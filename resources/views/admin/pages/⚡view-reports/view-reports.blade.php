                ...
                <div>
                    ...
                    <p class="text-sm text-black/50 dark:text-white/50 mt-0.5">
                        ...
                        @elseif ($this->isRegistrar)
                            Generate institutional reports across all batches.
                        @else
                            Reports for {{ $this->myDepartmentName }}.
                        @endif
                    </p>
                </div>
            </div>
            ...
            @if ($this->hasNoDepartment)
                <div
                    ...
                    <p class="text-sm text-amber-800/80 dark:text-amber-200/70 mt-2 max-w-md mx-auto">
                        You can't generate reports until the registrar assigns you to a department.
                    </p>
                </div>
            @else
                ...
                <div
                    ...
                    <div class="flex flex-wrap items-center gap-3 pt-3 border-t border-black/5 dark:border-white/5">
                        ...
                        {{-- Course (department is fixed for program heads) --}}
                                    ...
                                    <tfoot
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-end font-bold text-red-700 dark:text-red-400">
                                                {{ $t['unemployed'] }}</td>
                                            <td
                                                class="px-4 py-3 text-end font-bold text-amber-700 dark:text-amber-400">
                                                {{ $t['self_employed'] }}</td>
                                    ...
                                    <table class="min-w-full text-xs sm:text-sm">
                                        ...
                                        <tbody class="divide-y divide-black/5 dark:divide-white/5">
                                            @foreach ($this->topEmployers as $i => $row)
                                                ...
                                                <tr>
                                                    <td
                                                        class="px-4 py-2.5 font-bold text-[#123524]/40 dark:text-white/40">
                                                        {{ $i + 1 }}</td>
                                                    <td class="px-4 py-2.5 text-[#123524] dark:text-white font-medium">
                                                        {{ $row['company_name'] }}</td>
                                                    <td
