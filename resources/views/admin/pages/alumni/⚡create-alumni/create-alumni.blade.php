<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="bg-white border border-black/10 rounded-3xl p-8">
        <form wire:submit.prevent="saveAlumni" class="space-y-5">
            ...
            <!-- Password notice -->
            <div class="rounded-xl border border-black/10 bg-[#F1EFE7] p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-xs text-black/50 uppercase tracking-wide font-semibold">Default Password</p>
                        <p class="font-mono text-base font-bold text-[#123524] mt-1 break-all">csav.alumni</p>
