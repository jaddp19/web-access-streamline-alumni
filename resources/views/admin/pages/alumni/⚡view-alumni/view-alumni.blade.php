        ...
        <div class="flex flex-col rounded-2xl border border-black/5 dark:border-white/5 bg-white dark:bg-[#242526] shadow-sm">
            ...
            <div class="px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-black/5 dark:border-white/5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-[#123524] dark:text-white" style="font-family: 'Fraunces', serif;">Alumni</h2>
                        <p class="text-sm text-black/50 dark:text-white/50">Manage alumni records</p>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <button type="button" wire:click="exportCsv"
                        ...
                        class="inline-flex items-center justify-center gap-x-2 text-sm font-semibold rounded-xl bg-white dark:bg-[#3A3B3C] border border-black/10 dark:border-white/10 text-[#123524] dark:text-white hover:bg-black/5 dark:hover:bg-white/5 transition py-2.5 px-4 disabled:opacity-50">
                        ...
                        @forelse ($this->alumni as $profile)
                            <tr wire:key="alumni-{{ $profile->id }}" class="hover:bg-black/[0.02] dark:hover:bg-white/[0.03] transition-colors">
                                <td class="px-2 sm:px-6 py-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        @if ($avatarUrl)
                                            ...
                                            <div class="hidden w-8 h-8 rounded-full bg-[#123524]/10 dark:bg-[#D4A537]/15 items-center justify-center text-[#123524] dark:text-[#D4A537] text-xs font-bold shrink-0">
                                                {{ $initials }}
                                            </div>
                                        @else
                                        ...
                                        <span class="font-semibold text-[#123524] dark:text-white truncate">{{ $displayName }}</span>
                                    </div>
                                </td>
                                <td class="hidden sm:table-cell px-2 sm:px-6 py-3">
                                    <span class="text-black/70 dark:text-white/70">{{ $profile->user->email ?? 'N/A' }}</span>
                                </td>
                                <td class="hidden sm:table-cell px-2 sm:px-6 py-3">
                                ...
                                <td class="hidden md:table-cell px-2 sm:px-6 py-3">
                                    <span class="inline-flex items-center text-[10px] px-2 py-0.5 rounded-full bg-[#D4A537]/15 dark:bg-[#D4A537]/20 text-[#a97f1f] dark:text-[#E5B94A] font-semibold">
            ...
            <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-black/5 dark:border-white/5">
                <p class="text-sm text-black/60 dark:text-white/60">
                    <span class="font-semibold text-[#123524] dark:text-white">{{ $this->alumni->total() }}</span> results
                </p>
