<div>
    <div class="max-w-[85rem] mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-14">
        <div
            ...
            <!-- ===================== HEADER ===================== -->
            <div
                class="px-4 sm:px-6 py-4 sm:py-5 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4 border-b border-black/5 dark:border-white/5">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center gap-2 sm:gap-3">
                    ...
                    <div class="relative w-full lg:w-72 xl:w-80 shrink-0">
                        <input type="text" wire:model.live.debounce.400ms="search"
                            placeholder="name, email, school ID"
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 flex-1 min-w-0">
                        ...
                        <div class="relative flex-1 min-w-0">
                            <select wire:model.live="courseFilter" wire:loading.attr="disabled"
                                ...
                                class="w-full appearance-none py-2 pl-3 pr-8 text-xs sm:text-sm rounded-lg bg-[#F7F5EF] dark:bg-[#3A3B3C] border border-black/10 dark:border-white/10 text-black dark:text-white focus:outline-none focus:border-[#123524] dark:focus:border-[#D4A537] focus:ring-1 focus:ring-[#123524] dark:focus:ring-[#D4A537] cursor-pointer disabled:opacity-60 disabled:cursor-wait">
            ...
            <div class="sm:hidden divide-y divide-black/5 dark:divide-white/5">
                @forelse ($this->alumni as $profile)
                    ...
                    <div wire:key="mobile-alumni-{{ $profile->id }}" class="p-4 flex items-start gap-3">
                        ...
                        @else
                            <div
                                class="w-10 h-10 rounded-full bg-[#123524]/10 dark:bg-[#D4A537]/15 flex items-center justify-center text-[#123524] dark:text-[#D4A537] text-xs font-bold shrink-0">
                                {{ $initials }}
                            </div>
                        @endif
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-black/60 dark:text-white/60 truncate">
                                {{ $profile->user->email ?? 'N/A' }}</p>

                            <div class="mt-2 flex flex-wrap items-center gap-1.5">
                                @if ($profile->courses->count())
                                    <span
                                        class="text-[10px] px-2 py-0.5 rounded-full bg-[#D4A537]/15 text-[#a97f1f] dark:text-[#E5B94A] font-semibold">
                                        {{ $profile->courses->pluck('course_title')->filter()->first() }}
                                    </span>
                                @endif
                                @if ($profile->batch)
                                    <span
                                        class="text-[10px] px-2 py-0.5 rounded-full bg-[#123524]/5 dark:bg-white/10 text-[#123524]/60 dark:text-white/60 font-semibold">
                            ...
                            <tr wire:key="alumni-{{ $profile->id }}"
                                ...
                                <td class="px-3 lg:px-6 py-3">
                                    <div class="flex items-center gap-3 min-w-0">
                                        ...
                                        <div class="min-w-0">
                                            <span
                                                class="font-semibold text-[#123524] dark:text-white block truncate">{{ $displayName }}</span>
                                            <span
                                ...
                                <td class="hidden md:table-cell px-3 lg:px-6 py-3">
                                    <span
                                        class="text-black/70 dark:text-white/70 block truncate">{{ $profile->user->email ?? 'N/A' }}</span>
                                </td>
                                <td class="hidden md:table-cell px-3 lg:px-6 py-3">
                                ...
                                <td class="hidden lg:table-cell px-3 lg:px-6 py-3">
                                    <span
                                        class="inline-flex items-center text-[10px] px-2 py-0.5 rounded-full bg-[#D4A537]/15 dark:bg-[#D4A537]/20 text-[#a97f1f] dark:text-[#E5B94A] font-semibold whitespace-nowrap">
            ...
            <div
                ...
                <p class="text-xs sm:text-sm text-black/60 dark:text-white/60 text-center sm:text-left">
                    Showing
                    <span
                        class="font-semibold text-[#123524] dark:text-white">{{ $this->alumni->firstItem() ?? 0 }}</span>–<span
                        class="font-semibold text-[#123524] dark:text-white">{{ $this->alumni->lastItem() ?? 0 }}</span>
                    of
                    <span class="font-semibold text-[#123524] dark:text-white">{{ $this->alumni->total() }}</span>
                    results
                </p>
