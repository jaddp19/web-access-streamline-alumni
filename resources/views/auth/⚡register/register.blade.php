<div class="min-h-screen flex bg-[#F7F5EF]">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#123524]">
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute inset-0 opacity-[0.05]"
                style="background-image: radial-gradient(#D4A537 1px, transparent 1px); background-size: 28px 28px;">
            </div>
        </div>
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRC0rZblAbfgOgTt6ujr71K-2jf9gY65zHSUOVdPIFeKy1BENm-131U9vw&s=10"
            alt="Campus" class="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-overlay">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                        <svg class="w-4 h-4 text-[#D4A537]" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center px-6 sm:px-12 py-16 relative">
        ...
        <div class="w-full max-w-sm">
            ...
            <div class="mb-8">
                <h3 class="text-3xl font-bold text-[#123524]" style="font-family: 'Fraunces', serif;">Create Account
                </h3>
            ...
            <form wire:submit.prevent="register" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="w-5 h-5 text-[#123524]/40" fill="none" stroke="currentColor"
                ...
                <!-- School ID Number -->
                <div>
                    <label for="school_id" class="block text-sm font-semibold text-[#123524] mb-2">School ID
                        Number</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="w-5 h-5 text-[#123524]/40" fill="none" stroke="currentColor"
                        ...
                        <input wire:model.defer="school_id" type="text" id="school_id" name="school_id"
                ...
                <label class="flex items-start gap-2.5 text-sm text-[#123524]/70 cursor-pointer">
                    <input type="checkbox" required
                        class="mt-0.5 rounded border-[#123524]/30 text-[#123524] focus:ring-[#D4A537]">
                    <span>I agree to the <a href="#"
                            class="font-medium text-[#123524] hover:text-[#D4A537] transition-colors">Terms of
                            Service</a> and <a href="#"
                            class="font-medium text-[#123524] hover:text-[#D4A537] transition-colors">Privacy
                            Policy</a></span>
                </label>
                ...
                <p class="text-center text-sm text-[#123524]/70">
                    ...
                    <a href="{{ route('login') }}"
                        class="font-semibold text-[#123524] hover:text-[#D4A537] transition-colors">
                        Log in here
                    </a>
                </p>
            </form>
