                ...
                <form wire:submit="update" class="p-4 sm:p-6 space-y-4 sm:space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 mb-3">
                            @if ($dept_logo)
                                <img src="{{ $dept_logo->temporaryUrl() }}" alt="New logo preview" loading="lazy"
                            ...
                            @elseif ($department->dept_logo)
                                <img src="{{ filter_var($department->dept_logo, FILTER_VALIDATE_URL)
                                    ...
                                    alt="Current logo" loading="lazy"
                                    class="w-16 h-16 rounded-xl object-cover border border-black/10 dark:border-white/10 shrink-0"
                                    onerror="this.onerror=null; this.src='https://tse2.mm.bing.net/th/id/OIP.D0DJ0ePPxNcvYOeq6q9esQAAAA?pid=Api&P=0&h=180';">
                            @else
                                <div class="w-16 h-16 rounded-xl bg-[#F7F5EF] dark:bg-[#3A3B3C] border border-black/10 dark:border-white/10 flex items-center justify-center text-black/30 dark:text-white/30 text-xs shrink-0">
                                    No logo
                                </div>
                            @endif
                    ...
                    <div class="flex flex-col sm:flex-row sm:flex-wrap gap-3 pt-4 border-t border-black/5 dark:border-white/10">
                        <button type="submit" wire:loading.attr="disabled" wire:target="update,dept_logo"
