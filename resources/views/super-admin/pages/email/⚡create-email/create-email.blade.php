        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex flex-col rounded-2xl border border-black/5 bg-white shadow-sm p-6 sm:p-8">
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-[#123524]" style="font-family: 'Fraunces', serif;">Create Email Template</h2>
                        <p class="text-sm text-black/50">A URL-friendly slug will be generated from the subject</p>
                    </div>
                </div>
                ...
                <form wire:submit.prevent="create" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea wire:model.defer="message" id="message" rows="8"
                            class="w-full px-4 py-3 rounded-xl border border-[#123524]/15 bg-[#F7F5EF] text-[#123524] placeholder-[#123524]/30 focus:outline-none focus:ring-2 focus:ring-[#D4A537] focus:border-transparent transition"
