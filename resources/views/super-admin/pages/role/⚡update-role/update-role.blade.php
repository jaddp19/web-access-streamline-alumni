        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="rounded-2xl border border-black/5 dark:border-white/5 bg-white dark:bg-[#242526] shadow-sm">
                ...
                <div class="px-6 py-5 flex items-center gap-4 border-b border-black/5 dark:border-white/5">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-[#123524] dark:text-white" style="font-family: 'Fraunces', serif;">Update Role &amp; Permissions</h2>
                        <p class="text-sm text-black/50 dark:text-white/50">Editing {{ Str::title(str_replace('_', ' ', $role->name)) }}</p>
                    </div>
                </div>
