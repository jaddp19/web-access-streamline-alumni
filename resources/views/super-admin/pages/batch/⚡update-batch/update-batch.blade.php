        ...
        <div class="max-w-lg mx-auto">
            ...
            <div class="flex flex-col rounded-2xl border border-black/5 bg-white shadow-sm p-6 sm:p-8">
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-[#123524]" style="font-family: 'Fraunces', serif;">Update Batch Year</h2>
                        <p class="text-sm text-black/50">Editing batch: {{ $batch->batch_name }}</p>
                    </div>
                </div>
