            ...
            <div class="flex flex-col rounded-2xl border border-black/5 dark:border-white/5 bg-white dark:bg-[#242526] shadow-sm p-4 sm:p-6 lg:p-8 overflow-hidden">
                ...
                <div class="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-xs sm:text-sm text-black/50 dark:text-white/50">Add a new alumni batch to the system</p>
                    </div>
                </div>
                ...
                <form wire:submit="create" class="space-y-4 sm:space-y-5">
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove wire:target="create">Create Batch</span>
