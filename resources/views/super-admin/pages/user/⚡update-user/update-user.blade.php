              ...
              hover:bg-green-600 focus:outline-hidden">
                ...
                <form wire:submit.prevent='update'>
                    <div class="grid gap-4 lg:gap-6">
                        ...
                        <!-- Name -->
                        <div>
                            <label for="hs-name" class="block mb-2 text-sm font-medium text-black">Name</label>
                        ...
                        <!-- Email -->
                        <div class="mt-5">
                            <label for="hs-email" class="block mb-2 text-sm font-medium text-black">Email</label>
                        ...
                        <!-- School ID -->
                        <div class="mt-5">
                            <label for="hs-school_id" class="block mb-2 text-sm font-medium text-black">
                                School ID
                            </label>
                        ...
                        <!-- Password -->
                        <div class="mt-5">
                            <label for="hs-password" class="block mb-2 text-sm font-medium text-black">Password</label>
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-2">
                            @forelse ($this->roles as $role)
                                <label
                                    class="flex items-center p-3 w-full bg-green-50 shadow-2xl border-transparent rounded-lg text-sm hover:bg-gray-200 transition">
