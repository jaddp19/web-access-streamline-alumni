        ...
        <div class="bg-white border border-black/10 rounded-3xl p-8">
            <form wire:submit='update' class="space-y-5">
                ...
                <div>
                    ...
                    <input wire:model='name' type="text" name="hs-name" id="hs-name"
                ...
                <!-- Password -->
                <div>
                    <label for="hs-password" class="block mb-2 text-xs text-black/60 uppercase tracking-wide font-semibold">
                ...
                <div>
                    <label for="hs-password_confirmation" class="block mb-2 text-xs text-black/60 uppercase tracking-wide font-semibold">Confirm New Password</label>
