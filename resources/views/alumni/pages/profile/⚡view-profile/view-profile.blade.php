            ...
            <div class="bg-white dark:bg-[#242526] rounded-2xl shadow-sm p-5">
                ...
                <div class="grid sm:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-black dark:text-white mt-1">{{ $this->contact['phone_number_1'] ?? '—' }}</p>
                    </div>
                    @if ($this->contact['phone_number_2'])
                        <div>
                            ...
                            <p class="font-medium text-black dark:text-white mt-1"> {{ $this->contact['phone_number_2'] }}</p>
                        </div>
                    @endif
                </div>
