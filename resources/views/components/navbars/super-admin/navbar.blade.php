<div class="select-none">
    <div id="hs-pro-sidebar"
        ...
        <nav
            class="pt-16 lg:pt-16 p-2.5 h-full flex flex-col overflow-y-auto text-sm [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-white/5 [&::-webkit-scrollbar-thumb]:bg-white/20">
            ...
            @php
                $navGroups = [
                    'Overview' => [['route' => 'super-admin.dashboard', 'label' => 'Dashboard']],
                    'User Management' => [
            ...
            @foreach ($navGroups as $group => $items)
                <div class="pt-2 mt-2 border-t border-white/10 first:border-t-0 first:pt-0 first:mt-0">
                    <span
                        class="block ps-2 mb-1 font-bold text-[10px] uppercase text-yellow-500/80">{{ $group }}</span>
