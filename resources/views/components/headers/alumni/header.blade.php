...
<header
    ...
    <nav class="max-w-[1100px] mx-auto flex items-center justify-between px-4 py-2 gap-4">
        ...
        <div class="hidden lg:block relative" x-data="{ open: false }" @click.outside="open = false">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-150"
                ...
                {{-- Theme toggle --}}
                <div class="p-2 border-t border-white/10" x-data="{
                    ...
                    <button type="button" @click="toggle()"
                        ...
                        <span class="relative inline-flex h-5 w-9 shrink-0 rounded-full transition-colors"
                            ...
                            <span
                                class="absolute top-0.5 left-0.5 inline-block h-4 w-4 rounded-full bg-white shadow transform transition-transform"
        ...
        <div class="flex lg:hidden items-center">
            <button
                class="p-2 rounded-full bg-[#F0F2F5] dark:bg-[#3a3b3c] hover:bg-[#E4E6EB] dark:hover:bg-[#4e4f50] transition"
                id="menu-toggle">
    ...
    <div id="mobile-menu"
        ...
        <a href="{{ route('alumni.profile') }}"
            ...
            @endif
            <div class="min-w-0">
                <p class="font-bold text-black dark:text-white text-sm truncate">{{ $__authUser->name ?? 'Alumni' }}
                </p>
        ...
        <a type="button" href="{{ route('alumni.message') }}"
        ...
        <div
            class="[&>*]:w-full [&_button]:flex [&_button]:items-center [&_button]:gap-x-3 [&_button]:px-3 [&_button]:py-3 [&_button]:rounded-lg [&_button]:text-red-600 dark:[&_button]:text-red-400 [&_button]:hover:bg-red-50 dark:[&_button]:hover:bg-red-500/10 [&_button]:transition-colors [&_button]:font-medium">
            <livewire:auth::logout />
        </div>
    </div>
