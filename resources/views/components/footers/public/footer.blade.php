        ...
        <div class="max-w-7xl mx-auto px-6 py-10">
            <div class="flex flex-col items-center text-center gap-y-4">
                ...
                <div class="flex items-center gap-x-5 mt-1">
                    <a href="#" aria-label="Facebook" class="text-white/90 hover:text-[#D4A537] transition-colors">
                    ...
                    <a href="#" aria-label="Twitter" class="text-white/90 hover:text-[#D4A537] transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M22.46 6c-.77.35-1.6.58-2.46.69a4.3 4.3 0 001.88-2.37 8.59 8.59 0 01-2.72 1.04 4.28 4.28 0 00-7.29 3.9A12.14 12.14 0 013 4.9a4.28 4.28 0 001.32 5.71c-.7-.02-1.36-.21-1.94-.53v.05a4.28 4.28 0 003.43 4.19c-.65.18-1.34.2-2 .08a4.28 4.28 0 004 2.97A8.6 8.6 0 012 18.57 12.13 12.13 0 008.29 20.5c7.55 0 11.68-6.26 11.68-11.68 0-.18-.01-.36-.02-.53A8.35 8.35 0 0022.46 6z"/>
                        </svg>
                    </a>
                    <a href="#" aria-label="Email" class="text-white/90 hover:text-[#D4A537] transition-colors">
